      ...
      <div className="bg-white rounded-xl border border-[#1A56A8]/15 p-5">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center">
            ...
            <p className="text-xs text-[#0e2a5c]/60 mt-1">원문 수집</p>
          </div>
          <div className="text-center">
            <p className="text-2xl font-bold text-purple-600">
              {counts.rewritten}
            </p>
            <p className="text-xs text-[#0e2a5c]/60 mt-1">리라이팅 완료</p>
          </div>
          <div className="text-center">
            <p className="text-2xl font-bold text-green-600">
              {counts.published}
            </p>
            <p className="text-xs text-[#0e2a5c]/60 mt-1">게시중</p>
          </div>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#1A56A8] bg-[#1A56A8]">
                <th className="text-left py-3 px-4 text-white font-semibold w-[40%]">
                  제목
                </th>
            ...
            <tbody>
              {filtered.map((notice) => (
                ...
                >
                  <td className="py-3 px-4">
                    ...
                    <span className="text-xs text-[#0e2a5c]/50 block mt-0.5">
                      {notice.source} · {notice.createdAt}
                    </span>
                  </td>
                  <td className="py-3 px-4 text-gray-600 hidden sm:table-cell">
                    <span className="px-2.5 py-0.5 bg-[#1A56A8] text-white rounded text-xs font-medium">
                      {notice.fundType}
                    </span>
                  </td>
                  ...
                  <td className="py-3 px-4 text-[#0e2a5c]/60 hidden lg:table-cell">
              ...
              {filtered.length === 0 && (
                <tr>
                  <td
                    colSpan={7}
                    className="py-12 text-center text-[#0e2a5c]/50"
                  >
                    공고가 없습니다.
                  </td>
                </tr>
